...
def test_token_refresh():
    assert reverse("api:token_refresh") == "/api/token/refresh/"
...
def test_user_password_reset_confirm():
    ...
    assert resolve("/api/users/password-reset/confirm/").view_name == \
